...
```mermaid
graph TD
    A[中央服务器<br/>Central Server] --> B[开发者 A]
    A --> C[开发者 B]
    A --> D[开发者 C]
...
```mermaid
graph LR
    A[开发者 A<br/>完整仓库] <--> B[开发者 B<br/>完整仓库]
    B <--> C[开发者 C<br/>完整仓库]
    A <--> C
    A <--> D[远程仓库]
    B --> D
...
```mermaid
graph LR
    A[源文件<br/>file.txt] --> B[SHA-1<br/>哈希计算]
    B --> C[压缩存储<br/>.git/objects/<br/>ab/cdef123...]
...
graph TD
    A[Tree<br/>根目录] --> B[src/]
    A --> C[README.md<br/>blob: 1a2b3c]
    A --> D[package.json<br/>blob: 4d5e6f]
    
    B --> E[index.js<br/>blob: 7g8h9i]
    B --> F[utils/<br/>Tree]
    B --> G[config.js<br/>blob: j0k1l2]
    
    F --> H[helper.js<br/>blob: m3n4o5]
    F --> I[api.js<br/>blob: p6q7r8]
...
```mermaid
graph TD
    A[Commit<br/>abc123def] --> B[Tree: tree_hash<br/>工作目录快照]
    A --> C[Parent: parent_hash<br/>父提交]
    A --> D[Author: John Doe<br/>john@example.com]
    A --> E[Committer: John Doe<br/>john@example.com]
    A --> F[Timestamp: 2026-05-24<br/>16:30:00 +0800]
    A --> G[Message: feat:<br/>add new feature]
...
graph LR
    ...
    style A fill:#87CEEB,stroke:#333,stroke-width:1px
    style B fill:#87CEEB,stroke:#333,stroke-width:1px
    style C fill:#87CEEB,stroke:#333,stroke-width:1px
    style D fill:#87CEEB,stroke:#333,stroke-width:1px
    style E fill:#87CEEB,stroke:#333,stroke-width:1px
    style F fill:#FF6B6B,stroke:#333,stroke-width:2px,color:#fff
    style G fill:#4ECDC4,stroke:#333,stroke-width:2px,color:#fff
    style H fill:#FFA07A,stroke:#333,stroke-width:2px,color:#fff
```
...
graph TD
    ...
    style A fill:#FFD700,stroke:#333,stroke-width:2px
    style B fill:#FF6B6B,stroke:#333,stroke-width:1px
    style C fill:#FF6B6B,stroke:#333,stroke-width:1px
    style D fill:#4ECDC4,stroke:#333,stroke-width:1px
    style E fill:#4ECDC4,stroke:#333,stroke-width:1px
    style F fill:#9370DB,stroke:#333,stroke-width:3px,color:#fff
```
